...
//             $provider = 0;
            ...
            $IncomingRequests = $BeforeAssignProvider->get();
            ...
            $totalride = UserRequests::pluck('id');
...
//                }
            ...
            $Response = [
                    'account_status' => $Provider?$Provider->status:0,
                    'service_status' => $Provider?($Provider->service ? Auth::user()->service->status : 'offline'):'',
                    'trips' => $trips,
                    'earnings' => $earnings,
